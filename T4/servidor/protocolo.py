...
tcc = parametros.tamano_chunk_contenido # tcc = Tamano chunk contenido
tch = parametros.tamano_chunk_header # tch = Tamano chunk header
...
def decodificar_mensaje(datos):
    ...
    # Lee Header the 4 bytes en little endian
